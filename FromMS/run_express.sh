...
docker run -e 'ACCEPT_EULA=Y' -e "SA_PASSWORD=$SA_PWD" -e 'MSSQL_PID=Express' -p $PORT:1433 --name $CONTAINER_NAME -h $CONTAINER_NAME -d mcr.microsoft.com/mssql/server:2019-latest
exit 0
